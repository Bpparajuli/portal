...
<div class="mt-4">
    ...
    {{-- Filter Form --}}
    <form class="mb-4 p-3 border rounded bg-light" method="GET" action="{{ route('students.index') }}">
        <div class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-12 mt-3 d-flex justify-content-end">
                <a href="{{ route('students.index') }}" class="btn btn-secondary me-2">Clear Filters</a>
        ...
        <table class="table table-striped table-hover border">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('students.show', $student) }}" class="btn btn-sm btn-outline-primary me-1">View</a>
                        <a href="{{ route('students.edit', $student) }}" class="btn btn-sm btn-outline-secondary me-1">Edit</a>
