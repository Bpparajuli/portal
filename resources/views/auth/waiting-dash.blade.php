...
<div class="waiting-dashboard p-2" style="background: linear-gradient(135deg, var(--bg-light) 0%, var(--light-blue) 100%); min-height: 100vh;">
    <div class="container">
                ...
                <div class="card shadow-lg border-0 rounded-4 mb-4 overflow-hidden">
                    <div class="card-header text-white py-4" style="background: var(--active);">
                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                            <div>
                                ...
                                <p class="mb-0 opacity-75">{{ $user->business_name ?? $user->name }} - {{ $user->name }}</p>
                            </div>
                    ...
                    <div class="card-body p-4">
                        @if($user->agreement_status === 'not_uploaded')
                            <div class="alert alert-info border-0 rounded-3 mb-4" style="background: var(--light-blue);">
                                <div class="d-flex">
                            ...
                            <div class="alert alert-warning border-0 rounded-3 mb-4" style="background: #fff3e0;">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="mb-0">Your agreement is under review. You'll receive a notification once verified.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="alert alert-success border-0 rounded-3 mb-4" style="background: #d4edda;">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="mb-0">Your account is fully active. You can now access the agent dashboard.</p>
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="mb-5">
                            ...
                            <div class="progress-steps">
                                ...
                                <div class="step {{ $user->agreement_status == 'uploaded' ? 'active' : ($user->agreement_status == 'verified' ? 'completed' : '') }}">
                        ...
                        {{-- Instructions --}}
                        @if($user->agreement_status != 'verified')
                            <div class="instruction-box p-4 mb-4" style="background: var(--gray); border-radius: var(--radius);">
                                <h5 class="mb-3"><i class="fas fa-clipboard-list me-2" style="color: var(--primary);"></i>Steps to Complete Registration:</h5>
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <div class="instruction-item">
                                            ...
                                            <div class="step-content">
                                                ...
                                                <p class="mb-0 small">Download the standard agreement template</p>
                                                <a href="{{ asset('storage/agreement_template.docx') }}" class="btn btn-sm btn-outline-primary mt-2" download style="border-color: var(--primary); color: var(--primary);">
                                    ...
                                    <div class="col-md-6">
                                        <div class="instruction-item">
                                            ...
                                            <div class="step-content">
                                                ...
                                                <span class="badge mt-2" style="background: var(--warning);">Digital or Physical Signature</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        @if($user->agreement_status != 'verified')
                            <div class="upload-section">
                                <h5 class="mb-3">
                                    @if($user->agreement_file)
                                        <i class="fas fa-upload me-2" style="color: var(--primary);"></i>Update Agreement
                                    @else
                                        <i class="fas fa-cloud-upload-alt me-2" style="color: var(--primary);"></i>Upload Signed Agreement
                                    @endif
                                </h5>
                                    ...
                                    <div class="current-file mb-4 p-3 rounded-3">
                                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                                            <div>
                                                ...
                                                <a href="{{ asset('storage/' . $user->agreement_file) }}" target="_blank" class="ms-2" style="color: var(--primary);">
                                                    View Uploaded Agreement <i class="fas fa-external-link-alt fa-xs"></i>
                                                </a>
                                            </div>
                                            <span class="badge mt-2 mt-sm-0" style="background: {{ $user->agreement_status === 'uploaded' ? 'var(--warning)' : 'var(--muted)' }};">
                                ...
                                <form method="POST" action="{{ route('auth.agreement.upload') }}" enctype="multipart/form-data" id="uploadForm">
                                    @csrf
                                    <div class="mb-4">
                                        <label class="form-label fw-semibold">Agreement File (PDF format preferred)</label>

                                        <div class="dropzone-area" id="dropzone">
                                            <input type="file" name="agreement_file" id="agreement_file" accept=".pdf,.jpg,.jpeg,.png" {{ !$user->agreement_file ? 'required' : '' }}>
                                            ...
                                            <div class="selected-file d-none p-3" id="selectedFile">
                                                <div class="file-preview">
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-link text-danger float-end" id="removeFile">
                                    ...
                                    <button type="submit" class="btn btn-gradient w-100 py-3 fw-bold" id="uploadBtn">
                    ...
                    <div class="card-body p-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 text-md-end mt-3 mt-md-0">
                                <a href="mailto:support@ideacs.com" class="btn btn-outline-primary" style="border-color: var(--primary);">
