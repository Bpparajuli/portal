                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select name="agent_id" class="form-select">
                            ...
                            @php $selectedAgent = old('agent_id', $student->agent_id ?? null); @endphp
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="permanent_address" class="form-control"
                            value="{{ old('permanent_address', $student->permanent_address) }}" placeholder="Full permanent address">
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" name="temporary_address" class="form-control"
                            value="{{ old('temporary_address', $student->temporary_address) }}" placeholder="Current address if different">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="passed_year" class="form-control"
                            value="{{ old('passed_year', $student->passed_year) }}" placeholder="e.g. 2022" min="1990" max="{{ date('Y') }}">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="last_grades" class="form-control"
                            value="{{ old('last_grades', $student->last_grades) }}" placeholder="e.g. 3.6/4.0 or 75%">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-semibold small">Education Board</label>
                        <input type="text" name="education_board" class="form-control"
                            value="{{ old('education_board', $student->education_board) }}" placeholder="e.g. CBSE / Cambridge / NEB">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="preferred_country" class="form-control"
                            value="{{ old('preferred_country', $student->preferred_country) }}" placeholder="e.g. Canada, Australia">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="preferred_course" class="form-control"
                            value="{{ old('preferred_course', $student->preferred_course) }}" placeholder="e.g. Computer Science">
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="text" name="preferred_university" class="form-control"
                            value="{{ old('preferred_university', $student->preferred_university) }}" placeholder="University name">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        @if ($isEdit && $student->students_photo)
                            <img src="{{ Storage::url($student->students_photo) }}" class="photo-thumb mb-2 d-block" alt="Current Photo">
...
(function() {
    ...
    input.addEventListener('change', function() {
        ...
        } else if (preview) { preview.classList.add('d-none'); preview.src = ''; if (placeholder) placeholder.classList.remove('d-none'); }
    });
}());
</script>
@endpush
