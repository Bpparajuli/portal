...
<table class="table table-bordered table-striped">
    ...
    <tbody>
        ...
        <tr>
            <td onclick="window.location='{{ route('agent.universities.show', $university->id) }}'" style="cursor:pointer;">{{ $university->id }}</td>
            <td onclick="window.location='{{ route('agent.universities.show', $university->id) }}'" style="cursor:pointer;">
                @if($university->university_logo)
                <img src="{{ asset('images/uni_logo/' . $university->university_logo) }}" width="40" alt="Logo">
                @endif
            </td>
            <td onclick="window.location='{{ route('agent.universities.show', $university->id) }}'" style="cursor:pointer;">{{ $university->name }}</td>
            <td onclick="window.location='{{ route('agent.universities.show', $university->id) }}'" style="cursor:pointer;">{{ $university->short_name ?? 'N/A' }}</td>
