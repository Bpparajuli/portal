...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('agent.courses.index') }}" class="row g-3 align-items-end">
                <div class="col-md-4">
                ...
                <div class="col-md-2 d-flex gap-2">
                    ...
                    <a href="{{ route('agent.courses.index') }}" class="btn btn-secondary w-100">
            ...
            <table class=" table table-striped align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('agent.courses.show', $course->id) }}">
                                {{ $course->title }}
                            </a>
                        </td>
                        <td>
                            <a href="{{ route('agent.universities.show', $course->university->id) }}" class="text-blue-600 hover:underline">
