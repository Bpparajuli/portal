...
@section('admin-content')
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('admin.applications.index') }}" class="btn btn-outline-secondary btn-lg rounded-pill px-4">
        ...
        <div class="row g-4">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                            ...
                            <div class="text-muted">
                                ...
                                Created: {{ optional($application->created_at)->format('F j, Y') }}
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded-3">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <span class="fw-semibold">Days in process:</span>
                                        {{ number_format(optional($application->created_at)->diffInDays(now()) ?? 0) }}
                                        days
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-header bg-white border-0 pt-4 px-4">
                        <h5 class="fw-bold mb-0"><i class="fas fa-sync-alt me-2 text-primary"></i>Update Status</h5>
                    </div>
                    <div class="card-body p-4">
                        <form action="{{ route('admin.applications.update', $application->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="application_status_id" class="form-select rounded-pill" required>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content rounded-4">
                    ...
                    <div class="modal-footer border-0">
                        ...
                        <form action="{{ route('admin.applications.withdraw', $application->id) }}" method="POST"
                            class="d-inline">
                            @csrf
                            @method('PUT')
