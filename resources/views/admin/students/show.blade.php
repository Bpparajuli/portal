            ...
            <div class="col-12">
                <div class="d-flex flex-wrap justify-content-between align-items-center p-4 rounded-bottom-4"
                    ...
                    <div class="d-flex flex-column align-items-center gap-2 mt-3 mt-md-0">
                        <a href="{{ route('admin.students.index') }}" class="btn btn-outline-light px-4 shadow-sm">
                ...
                <div class="card border-0 rounded-4 shadow-lg sticky-top"
                    ...
                    <div class="card-body text-center p-4">
                        ...
                        <a href="{{ route('admin.users.show', $student->agent->slug) }}"
                            class="text-decoration-none fw-bold small text-secondary my-2">
                            {{ $student->agent?->business_name ?? ($student->agent?->username ?? '—') }}
                        </a>
                        <div class="mt-2 mb-4 position-relative d-inline-block">
                                                        ...
                                                        <div class="collapse show" id="messages-{{ $app->id }}">
                                                            <div class="border rounded-3 p-3 bg-light"
                                                                ...
                                                                @forelse($app->messages as $msg)
                                                                    <div
                                                                        class="d-flex mb-3 {{ $msg->type === 'admin' ? 'justify-content-start' : 'justify-content-end' }}">
                                                                        <div class="p-3 rounded-3 shadow-sm"
                                                                            style="max-width:75%; background-color: {{ $msg->type === 'admin' ? '#fff' : 'var(--primary)' }}; color: {{ $msg->type === 'admin' ? '#000' : '#fff' }};">
