...
<div>
    <div class="row justify-content-center">
        <div class="col-md-6 p-3 border border-primary rounded bg-white d-flex flex-column align-items-center">
            ...
            <form action="{{ route('admin.users.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="w-100">
                @csrf
                @method('PUT')
                <!-- Add this line -->
    ...
    <div class="row justify-content-center mt-3">
        <div class="col-md-6 d-inline-flex justify-content-center align-items-center">
            <a href="{{ route('admin.users.index') }}" class="btn bg-gray-400 btn-secondary">Back to User List</a>
        </div>
    </div>
</div>
@endsection
