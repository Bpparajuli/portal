...
<div class="container-fluid p-1">
    <div class="row">
            ...
            <div class="card border-0 shadow-sm rounded-4 sticky-top" style="top: 20px;">
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        ...
                        <img src="{{ Storage::url($user->business_logo) }}" alt="Logo" width="150" height="150" class="rounded-3 border shadow-sm object-fit-cover mb-3">
                        @else
                    ...
                    <div class="mt-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge bg-warning rounded-pill">{{ str_replace('_', ' ', $user->agreement_status) }}</span>
                        </div>
        ...
        <!-- Main Form Content -->
        <div class="col-lg-9">
            <form action="{{ route('admin.users.update', $user->slug) }}" method="POST" enctype="multipart/form-data" id="userForm">
                @csrf
                @method('PUT')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="form-check form-switch">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="status" id="statusToggle" value="1" {{ $user->active ? 'checked' : '' }} style="width: 3rem; height: 1.5rem; cursor: pointer;">
                                            <label class="form-check-label fw-medium ms-2" for="statusToggle" id="statusLabel">
                                                <span class="fw-semibold {{ $user->active ? 'text-success' : 'text-danger' }}">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control border-start-0 ps-0" name="business_name" value="{{ old('business_name', $user->business_name) }}" placeholder="Enter business name">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control border-start-0 ps-0" name="owner_name" value="{{ old('owner_name', $user->owner_name) }}" placeholder="Enter owner name">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control border-start-0 ps-0" name="name" value="{{ old('name', $user->name) }}" placeholder="Enter username">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control border-start-0 ps-0" name="email" value="{{ old('email', $user->email) }}" required placeholder="Enter email address">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control border-start-0 ps-0" name="contact" value="{{ old('contact', $user->contact) }}" placeholder="Enter contact number">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control border-start-0 ps-0" name="address" value="{{ old('address', $user->address) }}" placeholder="Enter address">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div id="parentFieldContainer" class="col-md-4" style="display: {{ $user->role === 'staff' ? 'block' : 'none' }};">
                                        ...
                                        <div class="border rounded-4 p-3 h-100">
                                            ...
                                            <div class="d-flex align-items-start gap-3">
                                                <div class="flex-shrink-0">
                                                    <img id="logoPreview" src="{{ $user->business_logo ? Storage::url($user->business_logo) : 'https://placehold.co/100?text=Logo' }}" class="rounded-3 border shadow-sm object-fit-cover" width="80" height="80" style="object-fit: cover;">
                                                </div>
                                            ...
                                            <div class="d-flex align-items-start gap-3">
                                                <div class="flex-shrink-0">
                                                    <a href="{{ Storage::url($user->registration) }}" target="_blank">
                                                        <img id="regPreview" src="{{ $user->registration ? Storage::url($user->registration) : 'https://placehold.co/100?text=File'}}" class="rounded-3 border shadow-sm" width="80" height="80" style="object-fit: cover;">
                                                    </a>
                                                </div>
                                                <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-start gap-3">
                                                <div class="flex-shrink-0">
                                                    <a href="{{ Storage::url($user->pan) }}" target="_blank">
                                                        <img id="panPreview" src="{{ $user->pan ? Storage::url($user->pan) : 'https://placehold.co/100?text=No File'}}" class="rounded-3 border shadow-sm" width="80" height="80" style="object-fit: cover;">
                                                    </a>
                                                </div>
                                                <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex align-items-start gap-3">
                                                <div class="flex-shrink-0">
                                                    <a href="{{ Storage::url($user->agreement_file) }}" target="_blank">
                                                        <img id="agreementPreview" src="{{ $user->agreement_file ? Storage::url($user->agreement_file) : 'https://placehold.co/100?text=No+File'}}" class="rounded-3 border shadow-sm" width="80" height="80" style="object-fit: cover;">
                                                    </a>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <button type="button" class="btn btn-outline-danger btn-sm" onclick="deleteAgreement('{{ route('admin.users.agreement.delete', $user->slug) }}', '{{ $user->business_name }}')">
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" name="password" id="passwordField" placeholder="Enter new password">
