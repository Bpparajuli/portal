...
<style>
    ...
    .table-hover-custom tbody tr:hover {
        background-color: rgba(26, 2, 98, 0.05);
...
<div class="container-fluid p-4">
        ...
        <div class="d-flex gap-2">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu export-dropdown">
                    <li><a class="dropdown-item" href="#" onclick="exportData('excel')"><i class="fas fa-file-excel me-2 text-success"></i>Export as Excel</a></li>
                    <li><a class="dropdown-item" href="#" onclick="exportData('csv')"><i class="fas fa-file-csv me-2 text-info"></i>Export as CSV</a></li>
                    <li><a class="dropdown-item" href="#" onclick="exportData('pdf')"><i class="fas fa-file-pdf me-2 text-danger"></i>Export as PDF</a></li>
                </ul>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold">{{ $admins instanceof \Illuminate\Pagination\LengthAwarePaginator ? $admins->total() : ($admins->count() ?? 0) }}</h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold">{{ $agents instanceof \Illuminate\Pagination\LengthAwarePaginator ? $agents->total() : ($agents->count() ?? 0) }}</h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="mb-0 fw-bold">{{ $staffs instanceof \Illuminate\Pagination\LengthAwarePaginator ? $staffs->total() : ($staffs->count() ?? 0) }}</h3>
                        </div>
    ...
    <div class="filter-section">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    <div class="input-group">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" class="form-control" placeholder="Search by name, email, business...">
                    </div>
                </div>
                <div class="col-md-2">
                    <select name="role" class="form-select" onchange="this.form.submit()">
                        ...
                        <option value="university" {{ request('role') === 'university' ? 'selected' : '' }}>Universities</option>
                ...
                <div class="col-md-2">
                    <select name="agreement" class="form-select" onchange="this.form.submit()">
                        ...
                        <option value="not_uploaded" {{ request('agreement') === 'not_uploaded' ? 'selected' : '' }}>Not Uploaded</option>
                        <option value="uploaded" {{ request('agreement') === 'uploaded' ? 'selected' : '' }}>Uploaded</option>
                        <option value="verified" {{ request('agreement') === 'verified' ? 'selected' : '' }}>Verified</option>
                    </select>
                </div>
                <div class="col-md-3">
                    <select name="sort" class="form-select" onchange="this.form.submit()">
                        ...
                        <option value="business_asc" {{ request('sort') === 'business_asc' ? 'selected' : '' }}>Business (A-Z)</option>
                        <option value="business_desc" {{ request('sort') === 'business_desc' ? 'selected' : '' }}>Business (Z-A)</option>
                    </select>
                </div>
            </div>
            ...
            <div id="advancedFilters" style="display: none;" class="mt-3">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="min_students" class="form-control" placeholder="Min students" value="{{ request('min_students') }}">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Minimum Applications</label>
                        <input type="number" name="min_applications" class="form-control" placeholder="Min applications" value="{{ request('min_applications') }}">
                    </div>
                </div>
        ...
        <div class="mt-3">
            ...
            <div class="d-flex flex-wrap mt-1">
                ...
                <div class="filter-badge">
                    <i class="fas fa-file-contract"></i> Agreement: {{ str_replace('_', ' ', ucfirst($activeFilters['agreement'])) }}
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light text-muted small">
                        <tr>
                            <th width="70">ID</th>
                            <th width="80">Logo</th>
                            <th class="sortable" onclick="sortBy('business_name')">Business <i class="fas fa-sort sort-icon"></i></th>
                            <th class="sortable" onclick="sortBy('name')">Name <i class="fas fa-sort sort-icon"></i></th>
                            <th>Email</th>
                            <th>Status</th>
                            <th class="sortable" onclick="sortBy('created_at')">Joined <i class="fas fa-sort sort-icon"></i></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                ...
                                <img src="{{ Storage::url($admin->business_logo) }}" alt="Logo" width="50" height="50" class="rounded-3 object-fit-cover shadow-sm border">
                                @else
                            ...
                            <td class="align-middle">
                                <a href="{{ route('admin.users.show', $admin->slug) }}" class="text-decoration-none fw-semibold text-dark">
                                    {{ $admin->business_name }}
                                </a>
                            </td>
                            ...
                            <td class="align-middle">
                                <span class="badge {{ $admin->active ? 'bg-success' : 'bg-secondary' }} rounded-pill bg-opacity-10 p-2 text-success"">
                            ...
                            <td class="align-middle text-end">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-3">
                                        <li><a class="dropdown-item py-2" href="{{ route('admin.users.show', $admin->slug) }}"><i class="fas fa-eye me-2"></i> View</a></li>
                                        <li><a class="dropdown-item py-2" href="{{ route('admin.users.edit', $admin->slug) }}"><i class="fas fa-edit me-2"></i> Edit</a></li>
                                        @if(in_array(auth()->id(), [1, 2]) && $admin->id !== auth()->id())
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        <li><button class="dropdown-item py-2 text-danger" onclick="confirmDelete('{{ route('admin.users.destroy', $admin->slug) }}', '{{ $admin->business_name }}')"><i class="fas fa-trash me-2"></i> Delete</button></li>
                                        @endif
                                    </ul>
                                </div>
                            </td>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                ...
                                <img src="{{ Storage::url($staff->business_logo) }}" alt="Logo" width="50" height="50" class="rounded-3 object-fit-cover shadow-sm border">
                                @else
                                <div class="bg-secondary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center" style="width: 50px; height: 50px;">
                                    <i class="fas fa-user text-secondary"></i>
                                </div>
                            ...
                            <td class="align-middle">
                                <a href="{{ route('admin.users.show', $staff->slug) }}" class="text-decoration-none fw-semibold text-dark">
                                    {{ $staff->business_name }}
                                </a>
                            </td>
                            ...
                            <td class="align-middle">
                                <span class="badge {{ $staff->active ? 'bg-success' : 'bg-secondary' }} rounded-pill bg-opacity-10 p-2 text-success"">
                                 <i class=" fas fa-circle me-1" style="font-size: 10px;"></i>
                            ...
                            <td class="align-middle text-end">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-3">
                                        <li><a class="dropdown-item py-2" href="{{ route('admin.users.show', $staff->slug) }}"><i class="fas fa-eye me-2"></i> View</a></li>
                                        <li><a class="dropdown-item py-2" href="{{ route('admin.users.edit', $staff->slug) }}"><i class="fas fa-edit me-2"></i> Edit</a></li>
                                        @if(in_array(auth()->id(), [1, 2]) && $staff->id !== auth()->id())
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        <li><button class="dropdown-item py-2 text-danger" onclick="confirmDelete('{{ route('admin.users.destroy', $staff->slug) }}', '{{ $staff->business_name }}')"><i class="fas fa-trash me-2"></i> Delete</button></li>
                                        @endif
                                    </ul>
                                </div>
                            </td>
        ...
        <div class="card-footer bg-white border-0 pt-3">
            <div class="d-flex justify-content-between align-items-center">
                <div class="text-muted small">
                    Showing {{ $staffs->firstItem() }} to {{ $staffs->lastItem() }} of {{ $staffs->total() }} staff
                </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 mb-4">
        ...
        <div class="card-body p-0">
                            ...
                            <td class="align-middle">
                                <div class="d-flex align-items-center">
                                    <div class="me-3">
                                        ...
                                        <img src="{{ Storage::url($agent->business_logo) }}" alt="Logo" width="50" height="50" class="rounded-3 object-fit-cover shadow-sm border">
                                        @else
                                        <div class="bg-secondary bg-opacity-10 rounded-3 d-flex align-items-center justify-content-center border" style="width: 38px; height: 38px;">
                                            <i class="fas fa-building text-secondary small"></i>
                                        </div>
                                        @endif
                                    </div>
                                    <div class="lh-sm">
                                        <a href="{{ route('admin.users.show', $agent->slug) }}" class="text-decoration-none fw-bold text-dark d-block mb-0">
                                            {{ $agent->business_name }} <span class="fw-semibold text-muted"><small>- {{ $agent->created_at->format('M d ') }}</small></span>
                                        </a>
                                        <small class="text-muted">{{ $agent->owner_name }}</small>
                                    </div>
                                </div>
                            </td>
                            <td class="align-middle">
                                <div class="d-flex flex-column small">
                                    <div class="text-truncate" style="max-width: 250px;" title="{{ $agent->email }}">
                                        <a href="mailto:{{ trim($agent->email) }}" class="text-decoration-none text-reset">
                                            <i class="fas fa-envelope text-muted me-2" style="width: 14px;"></i>{{ $agent->email }}
                                        </a>
                                    </div>
                                    <div class="text-nowrap mt-1">
                                        <a href="tel:{{ preg_replace('/[^0-9+]/', '', $agent->contact) }}" class="text-decoration-none text-muted">
                                            <i class="fas fa-phone text-muted me-2" style="width: 14px;"></i>{{ $agent->contact ?? 'N/A' }}
                                        </a>
                                    </div>
                                </div>
            </div>
            ...
            <td class="align-middle">
                <span class="badge {{ $agent->active ? 'bg-success' : 'bg-secondary' }} rounded-pill bg-opacity-10 p-2 text-success"">
                <i class=" fas fa-circle me-1" style="font-size: 10px;"></i>
        ...
        <td class="align-middle">
            ...
            'verified' => 'bg-success text-light',
...
<td class="align-middle text-end">
    <div class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow border-0 rounded-3">
            <li><a class="dropdown-item py-2" href="{{ route('admin.users.show', $agent->slug) }}"><i class="fas fa-eye me-2"></i> View</a></li>
            <li><a class="dropdown-item py-2" href="{{ route('admin.users.edit', $agent->slug) }}"><i class="fas fa-edit me-2"></i> Edit</a></li>
            @if(in_array(auth()->id(), [1, 2]) && !in_array($agent->id, [1, 2]))
            <li>
                <hr class="dropdown-divider">
            </li>
            <li><button class="dropdown-item py-2 text-danger" onclick="confirmDelete('{{ route('admin.users.destroy', $agent->slug) }}', '{{ $agent->business_name }}')"><i class="fas fa-trash me-2"></i> Delete</button></li>
            @endif
        </ul>
    </div>
    </div>
