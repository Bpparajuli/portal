                                    ...
                                    <td class="text-end">
                                        <div class="d-flex gap-1 justify-content-end">
                                            ...
                                            <form action="{{ route('admin.pages.destroy', $page) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete this page?')">
                                                @csrf @method('DELETE')
                                                <button type="submit" class="btn btn-sm btn-ghost" title="Delete"><i class="fas fa-trash-alt text-danger"></i></button>
                                            </form>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div class="modal-content">
            <form method="POST" action="{{ route('admin.settings.update', $setting) }}" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <form action="{{ route('admin.settings.destroy', $setting) }}" method="POST" class="me-auto" onsubmit="return confirm('Delete this setting?')">
                        @csrf @method('DELETE')
