...
@section('admin-content')
        ...
        <div class="dash-hero-inner">
            <div>
                ...
                <div class="dash-hero-sub">
                    {{ !empty($welcomeMessage) && $welcomeMessage !== 'Welcome to the admin dashboard.' ? $welcomeMessage : "Here's everything happening across your portal right now." }}
                </div>
            </div>
                ...
                <tbody>
                    @forelse($latestApplications as $app)
                        <tr>
                            ...
                            <td><a href="{{ $app->student ? route('admin.students.show', $app->student->id) : '#' }}"
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li><a class="dropdown-item"
                                                href="{{ $app->student ? route('admin.students.show', $app->student->id) : '#' }}"><i
    ...
    @if (auth()->check() && auth()->user()->id == 2)
        <div class="mt-2">
            <a href="{{ route('admin.backup.index') }}" class="btn btn-outline-secondary btn-sm"><i
