    ...
    <div class=" mt-4">
        <div class="row justify-content-center">
            <div class="col-lg-2 col-md-4 col-sm-4 m-2">
                <a href="{{ route('login') }}" class="btn bg-success login-btn">Login</a>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-4 m-2">
                <a href="{{ route('register') }}" class="btn bg-gray-500 register-btn">Register</a>
            </div>
        </div>
    </div>
...
<div class="main-div bg-secondary">
    <div class="row d-flex justify-content-between align-items-center">
        ...
        <div class="right-section col-md-7 d-flex p-2 align-items-center">
            <div class="col-xl-8 col-lg-7 col-md-7 text-white">
                <h4>Upto 70% Scholarship on all admissions</h4>
                <p>Trusted by Partners around Nepal</p>
            </div>
            <div class="col-xl-4 col-lg-5 col-md-5">
                <button class="bg-white p-2 rounded border-0">
                    <a href="#" class="text-dark text-decoration-none">
        ...
        <div class="left-section col-md-5">
            <img src="{{ asset('images/banner-2.png') }}" alt="banner-img" class="img-fluid">
        </div>
    </div>
</div>
