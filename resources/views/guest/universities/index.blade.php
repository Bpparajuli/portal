        ...
        <div class="uni-col">
            <div class="uni-card">
                ...
                <div class="uni-card-body">
                    <a href="{{ route('guest.universities.show', $uni->id) }}" class="uni-name-link">
                ...
                <div class="uni-table-wrapper">
                    <table class="uni-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><a href="{{ route('guest.courses.show', $course->id) }}">{{ $course->course_code }}</a></td>
                                <td><a href="{{ route('guest.courses.show', $course->id) }}">{{ $course->title }}</a></td>
