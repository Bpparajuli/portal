            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="card shadow-lg border-0 rounded-4">
                        <div class="card-header bg-idea2 text-primary text-center py-4">
                        ...
                        <div class="card-body p-5">
                            ...
                            <p class="text-muted">
                                By accessing and registering with <strong>Idea Consultancy Services</strong>, you agree to
                            ...
                            <ul class="text-muted">
                                <li>Must be the registered company in the respective country by following the registration
                                    act.</li>
                            ...
                            <p class="text-muted">
                                ...
                                for all activities under your account. Notify us immediately if you suspect unauthorized
                                access.
                            </p>

                            <h4 class="fw-bold mt-4 mb-3">4. Use of Services</h4>
                            <p class="text-muted">
                                Our platform must only be used for legitimate purposes such as student consultation,
                                application submissions, and document management.
                                Any misuse including fraud, misrepresentation, or spamming will result in termination of
                                your account.
                            </p>

                            <h4 class="fw-bold mt-4 mb-3">5. Intellectual Property</h4>
                            <p class="text-muted">
                                All content, logos, and trademarks displayed on our website are the property of Idea
                            ...
                            <p class="text-muted">
                                ...
                                the use or inability to use our services, including but not limited to delays, errors, or
                                interruptions.
                            </p>
                            ...
                            <p class="text-muted">
                                ...
                                engage in
                                unlawful activities. Upon termination, your access to the platform will be revoked
                                immediately.
                            </p>
                            ...
                            <ul class="text-muted">
                                ...
                                <li><i class="fas fa-map-marker-alt me-2 text-danger"></i> Baneshwor-10, Kathmandu, Nepal
                                </li>
                            </ul>
