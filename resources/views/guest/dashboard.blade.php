    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-success">
                        ...
                        <p class="text-muted">If needed, you can upload a newer version of the agreement below.</p>
                        <a href="{{ route('agent.dashboard') }}" class="btn btn-primary"> Go to homepage </a>
                    </div>
                    @endif
            ...
            <div class="text-center mt-4">
                <p class="text-muted mb-0">If you haven't received an agreement, contact the admin.</p>
            </div>
