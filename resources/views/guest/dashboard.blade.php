    ...
    <div class="dash-dashboard">
        ...
        <section class="dash-hero">
            <div class="dash-hero-text" data-aos="fade-right">
                ...
                <p class="dash-lead">Stay updated with the application status, manage students, find universities and search
                    courses easily. Login or register to get started.</p>
                <div class="dash-hero-buttons">
                    <a href="{{ route('auth.register') }}" class="btn white-base primary"> <i class="fa fa-user-plus"></i>
                        Register</a>
                    <a href="{{ route('guest.universities.index') }}" class="btn white-base secondary"> <i
        ...
        <section class="countries-section">
            ...
            <div class="countries-custom-grid">
                ...
                <a href="#" class="country-card double">
                    <img src="https://images.pexels.com/photos/109629/pexels-photo-109629.jpeg?auto=compress&cs=tinysrgb&w=600"
                        alt="Germany" />
                    <div class="overlay">
                        <h3>Germany</h3>
                    </div>
                ...
                <a href="#" class="country-card single">
                    <img src="https://images.pexels.com/photos/356844/pexels-photo-356844.jpeg?auto=compress&cs=tinysrgb&w=600"
                        alt="USA" />
                    <div class="overlay">
                        <h3>USA</h3>
                    </div>
                ...
                <a href="#" class="country-card single">
                    <img src="https://images.pexels.com/photos/51363/london-tower-bridge-bridge-monument-51363.jpeg?auto=compress&cs=tinysrgb&w=900"
                        alt="UK" />
                    <div class="overlay">
                        <h3>UK</h3>
                    </div>
                ...
                <a href="#" class="country-card double">
                    <img src="https://images.pexels.com/photos/325193/pexels-photo-325193.jpeg?auto=compress&cs=tinysrgb&w=600"
                        alt="Dubai" />
                    <div class="overlay">
                        <h3>Dubai</h3>
                    </div>
                ...
                <a href="#" class="country-card single">
                    <img src="https://images.pexels.com/photos/548077/pexels-photo-548077.jpeg?auto=compress&cs=tinysrgb&w=600"
                        alt="France" />
                    <div class="overlay">
                        <h3>Malta</h3>
                    </div>
            ...
            <div class="testimonial-slider-container">
                ...
                <div class="dash-testimonial-slider" id="testimonial-slider">
                    <div class="dash-testimonial-card">
                        <p>"The way documents are handled in IDEA’s portal is very smooth and hassle-free. Everything is
                            organized, making the application process easy."</p>
                        <h4>- Ramesh Kumar Thapa, Kathmandu, Nepal</h4>
                    </div>
                    <div class="dash-testimonial-card">
                        <p>"Finding courses and university details is really simple. The portal makes it easy to find
                            universities and available courses without any confusion."</p>
                        <h4>- Anisha Gurung, Pokhara, Nepal</h4>
                    </div>
                    <div class="dash-testimonial-card">
                        <p>"The IDEA team members are very supportive. They guide us at every step and are always available
                            to answer questions."</p>
                        <h4>- Suman Shah, Biratnagar, Nepal</h4>
                    </div>
                    <div class="dash-testimonial-card">
                        <p>"The training sessions organized by IDEA were extremely helpful. They gave practical insights and
                            prepared us well for the application and visa process."</p>
                        <h4>- Sabina KC, Bhaktapur, Nepal</h4>
                    </div>
                    <div class="dash-testimonial-card">
                        <p>"Germany is such a great study destination, and IDEA has promoted it effectively. We are
                            receiving complete support for our Germany applications."</p>
                        <h4>- Manoj Adhikari, Dharan, Nepal</h4>
                    </div>
                    <div class="dash-testimonial-card">
                        <p>"This inbuilt portal by IDEA is fantastic. It is user-friendly, intuitive, and makes navigating
                            courses and universities very easy."</p>
                        <h4>- Priya Thapa Magar, Chitwan, Nepal</h4>
                    </div>
                    <div class="dash-testimonial-card">
                        <p>"The portal is simple to use, yet it offers many advanced functions. From checking eligibility to
                            uploading documents, everything is seamless."</p>
                        <h4>- Suman Lama, Ilam, Nepal</h4>
                    </div>
                    <div class="dash-testimonial-card">
                        <p>"We are grateful that courses, university details, and other important info are visible on the
                            homepage without even logging in. This is excellent service!"</p>
                        <h4>- Ritu Shrestha, Kathmandu, Nepal</h4>
                    </div>
                    <div class="dash-testimonial-card">
                        <p>"IDEA’s training and support system is top-notch. Every session adds value and helps in
                            understanding the application process better."</p>
                        <h4>- Dev Raj Bhatt, Kailali, Nepal</h4>
                    </div>
                    <div class="dash-testimonial-card">
                        <p>"The IDEA team communicates clearly and promptly. They are helpful, professional, and make the
                            whole study abroad process smooth."</p>
                        <h4>- Sunita Karki, Pokhara, Nepal</h4>
                    </div>
                    <div class="dash-testimonial-card">
                        <p>"The portal allows us to track our application progress easily. Its organized layout and simple
                            navigation make it very convenient."</p>
                        <h4>- Pramod Kunwar, Lalitpur, Nepal</h4>
                    </div>
                    <div class="dash-testimonial-card">
                        <p>"We love that IDEA’s portal combines everything in one place—course info, university details, and
                            support resources—making it very efficient and reliable."</p>
