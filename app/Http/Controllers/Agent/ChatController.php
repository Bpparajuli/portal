...
class ChatController extends Controller
{
    ...
    {
        return response()->json($this->getUserListData(Auth::id(), ['admin', 'staff']));
    }

    private function getUserListData(int $authId, array $allowedRoles = ['admin', 'staff'])
    {
